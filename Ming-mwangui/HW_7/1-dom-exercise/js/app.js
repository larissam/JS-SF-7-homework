...
headingText = document.getElementById('headline');
...
var text = headingText.innerHTML;
console.log("headingText text: ", text);
...
var firstItemRepeat;
firstItemRepeat = document.querySelector('.parklist li');
console.log("firstItemRepeat: ", firstItemRepeat);
...
var parks;
parks = document.querySelectorAll('li');
...
var parksRepeat;
document.querySelectorAll('.cf').className = 'parksRepeat';
