...
function printLyric(bottlesLeft, startBottle) {
    ...
    var $lyricList = $('#ulLyrics'); //***CHANGED TO JQUERY
    ...
    if (bottlesLeft > 0) {
        ...
        //***CHANGED TO JQUERY
        var $lyricsLine = $('<li>'); 
        $lyricsLine.text(lyrics[0].replace(/##/g, bottlesLeft));
        $lyricList.append($lyricsLine);
        ...
        //***CHANGED TO JQUERY
        var $lyricsLine = $('<li>');
        $lyricsLine.text(temp.replace(/##/g, (bottlesLeft - 1)));
        $lyricList.append($lyricsLine);
    }
    ...
    if (bottlesLeft === 0) {
        ...
        //***CHANGED TO JQUERY
        var $lyricsLine = $('<li>');
        $lyricsLine.text(lyrics[3].replace(/##/g, startBottle));
        $lyricList.append($lyricsLine);
    }
